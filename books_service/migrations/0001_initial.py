# Generated by Django 6.1 on 2026-08-18 14:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='borrowings', to='books_service.book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('PAYMENT', 'Payment'), ('FINE', 'Fine')], max_length=30)),
                ('session_url', models.URLField(max_length=500)),
                ('session_id', models.CharField(max_length=255)),
                ('money_to_pay', models.DecimalField(decimal_places=2, max_digits=10)),
                ('borrowing', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='payments', to='books_service.borrowing')),
            ],
        ),
    ]
